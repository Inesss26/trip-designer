...
export const demoContent: SiteContentEntry[] = [
  ...
  },
  {
    ...
    kind: "text",
    value: "agathe@mytripdesigner.fr",
    sortOrder: 2,
    updatedAt: now,
  },
  {
  ...
  },
  {
    ...
    kind: "text",
    value:
      "Votre voyage sur-mesure, avec l'esprit Dolce Vita",
    sortOrder: 11,
    updatedAt: now,
  },
  {
  ...
  },
  {
    ...
    kind: "text",
    value: "Réserver mon appel découverte",
    sortOrder: 13,
    updatedAt: now,
  },
  {
    ...
    kind: "text",
    value: "Choisissez votre façon de voyager",
    sortOrder: 20,
    updatedAt: now,
  },
  {
