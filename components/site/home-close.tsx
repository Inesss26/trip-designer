...
export function HomeCommunity({ instagram }: { instagram?: string }) {
  ...
  return (
    <section className="bg-brand-sand px-4 py-14 sm:px-8 sm:py-[72px] lg:px-11">
        ...
        <div className="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-end">
          <div className="flex max-w-[436px] flex-col gap-5">
            ...
            <h2 className="font-heading text-[32px] leading-10 font-bold tracking-[-0.84px] text-brand sm:text-[42px] sm:leading-[48px]">
              La Dolce Vita au{" "}
              <span className="italic text-brand-teal">quotidien.</span>
            </h2>
          </div>
...
export function HomeCta() {
  return (
    <section className="relative flex min-h-[520px] flex-col items-center justify-center gap-6 px-4 py-16 text-center sm:min-h-[674px] sm:px-8">
      ...
      <div
        aria-hidden
        className="absolute inset-0 bg-gradient-to-b from-brand-navy/60 to-brand/30"
      />
      <div className="relative flex max-w-[512px] flex-col items-center gap-6">
        ...
        <h2 className="font-heading text-[32px] leading-10 font-bold tracking-[-0.84px] text-white sm:text-[42px] sm:leading-[48px]">
          Votre dolce vita vous attend.
          <br />
          Parlons-en.
        </h2>
        <p className="max-w-[448px] text-[15px] leading-5 font-light text-white">
        ...
        <p className="text-[10px] font-medium tracking-[0.6px] text-white uppercase">
